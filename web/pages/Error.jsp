...
isErrorPage="true" %> <%@ taglib prefix="c" uri="jakarta.tags.core" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="error-container">
      ...
      <c:if test="${not empty exception}">
        ...
        <button type="button" class="toggle-details" id="toggleStack">
          Show Stack Trace
        </button>

        <div class="stack-trace hidden" id="stackTrace">
          <strong>Stack Trace:</strong><br /> <% if (exception != null) {
          java.io.StringWriter sw = new java.io.StringWriter();
          java.io.PrintWriter pw = new java.io.PrintWriter(sw);
          exception.printStackTrace(pw); out.println(sw.toString().replace("\n",
          "<br />")); } %>
        </div>
      </c:if>
      ...
      <c:if test="${param.debug eq 'true'}">
        <div class="error-details">
          <strong>Debug Info:</strong><br /> Request URI:
          ${pageContext.request.requestURI}<br /> Context Path:
          ${pageContext.request.contextPath}<br /> Servlet Path:
      ...
      <div style="margin-top: 30px">
        <a
          href="${pageContext.request.contextPath}/pages/authen/SignIn.jsp"
          class="btn"
        >
