                  ...
                  <div class="car-full-specs">
                    ...
                    <div class="car-amenities">
                      ...
                      <div class="amenities-grid">
                        <span
                          ><i class="fas fa-snowflake"></i> Air
                          Conditioning</span
                        >
                  ...
                  <div class="car-gallery">
                    ...
                    <div class="gallery-thumbnails">
                      <img
                        ...
                        alt="Mazda CX-5 1"
                        class="thumbnail active"
                        onclick="selectImage(4, 0)"
                      />
                      <img
                        src="/placeholder.svg?height=80&width=120"
                        alt="Mazda CX-5 2"
                        class="thumbnail"
                        onclick="selectImage(4, 1)"
                      />
                      <img
                        src="/placeholder.svg?height=80&width=120"
                        alt="Mazda CX-5 3"
                        class="thumbnail"
                        onclick="selectImage(4, 2)"
                      />
                      <img
                        src="/placeholder.svg?height=80&width=120"
                        alt="Mazda CX-5 4"
                        class="thumbnail"
                        onclick="selectImage(4, 3)"
                      />
                    </div>
                  </div>
                  <div class="car-full-specs">
                    ...
                    <div class="car-description">
                      <h5>Description</h5>
                      <p>
                        Premium SUV with advanced safety features and luxurious
                        interior. Ideal for long trips and special occasions.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div class="modal-body">
          ...
          <div class="voucher-item" onclick="selectVoucher('SAVE5PERCENT', 5)">
            <div class="voucher-info">
              ...
              <div class="voucher-desc">
                5% discount on all orders (max 100K)
              </div>
            </div>
          ...
          <div class="voucher-item" onclick="selectVoucher('SAVE8PERCENT', 8)">
            <div class="voucher-info">
              ...
              <div class="voucher-desc">
                8% discount on all orders (max 150K)
              </div>
            </div>
          ...
          <div class="voucher-item" onclick="selectVoucher('SAVE3PERCENT', 3)">
            <div class="voucher-info">
              ...
              <div class="voucher-desc">
                3% discount on all orders (max 50K)
              </div>
            </div>
          ...
          <div
            class="voucher-item"
            onclick="selectVoucher('SAVE10PERCENT', 10)"
          >
            <div class="voucher-info">
              <div class="voucher-code">SAVE10PERCENT</div>
              <div class="voucher-desc">
                10% discount on all orders (max 200K)
              </div>
            </div>
          ...
          <div
            class="voucher-item"
            onclick="selectVoucher('SAVE12PERCENT', 12)"
          >
            <div class="voucher-info">
              <div class="voucher-code">SAVE12PERCENT</div>
              <div class="voucher-desc">
                12% discount on all orders (max 250K)
              </div>
            </div>
