...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<%= request.getContextPath() %>/styles/booking-form/booking-form-multiple.css">
                        ...
                        <div class="cars-list-container">
                            ...
                            <div class="car-item">
                                <div class="car-header" onclick="toggleCarDetails(1)">
                                    <div class="car-basic-info">
                                        <img src="/placeholder.svg?height=80&width=120" alt="KIA SEDONA PREMIUM 2017" class="car-thumbnail">
                            ...
                            <div class="car-item">
                                <div class="car-header" onclick="toggleCarDetails(2)">
                                    <div class="car-basic-info">
                                        <img src="/placeholder.svg?height=80&width=120" alt="Toyota Vios 2020" class="car-thumbnail">
                                        <div class="car-title-price">
                            ...
                            <div class="car-item">
                                <div class="car-header" onclick="toggleCarDetails(3)">
                                    <div class="car-basic-info">
                                        <img src="/placeholder.svg?height=80&width=120" alt="Honda City 2019" class="car-thumbnail">
                                        <div class="car-title-price">
                        ...
                        <div class="booking-form-container">
                            ...
                            <form id="bookingForm" action="booking-form-deposit.jsp" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="notes" name="notes" rows="3" placeholder="Special requests for multiple cars..."></textarea>
                                </div>
