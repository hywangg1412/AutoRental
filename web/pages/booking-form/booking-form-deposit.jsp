...
<html lang="vi">
  <head>
    ...
    <link
      rel="stylesheet"
      href="styles/booking-form/booking-form-deposit.css"
    />
    <link
      rel="stylesheet"
            ...
            <div class="terms-container">
              ...
              <div class="terms-content">
                <div class="term-item">
                  ...
                  <p>
                    Customer needs to deposit 30% of the total rental contract
                    value to reserve. The deposit will be deducted from the
                    final payment.
                  </p>
                </div>
                ...
                <div class="term-item">
                  ...
                  <ul>
                    ...
                    <li>
                      Household registration book or temporary residence (if
                      renting long-term)
                    </li>
                  </ul>
                </div>
                ...
                <div class="term-item">
                  <h4>
                    <i class="fas fa-shield-alt"></i> Insurance and
                    Responsibility
                  </h4>
                  <p>
                    The car is fully insured according to regulations. Customers
                    are responsible for traffic violations and damages due to
                    misuse.
                  </p>
                </div>
                ...
                <div class="term-item">
                  ...
                  <p>
                    The car is delivered with a full tank of gas. Customers need
                    to return the car with the same fuel level or pay the fuel
                    fee.
                  </p>
                </div>
                ...
                <div class="term-item">
                  <h4>
                    <i class="fas fa-clock"></i> Car Pick-up and Return Time
                  </h4>
                  <p>
                    Flexible car pick-up and return time from 6:00 - 22:00
                    daily. Surcharge of 100K for pick-up/return outside of
                    hours.
                  </p>
                </div>
                ...
                <div class="term-item">
                  ...
                  <p>
                    For any technical problems during use, please contact the
                    hotline for support. Do not repair without permission.
                  </p>
                </div>
                ...
                <div class="term-item">
                  ...
                  <p>
                    Customers who violate the terms will be charged a penalty
                    according to regulations and may be refused service in the
                    future.
                  </p>
                </div>
              </div>
              ...
              <div class="agreement-section">
                <label class="checkbox-container">
                  ...
                  I have read and agree to all the deposit terms and conditions
                  above
                </label>
              </div>
            </div>
              ...
              <div class="payment-details" id="bankPayment">
                ...
                <div class="bank-info">
                  ...
                  <div class="info-item">
                    ...
                    <span
                      class="copyable"
                      onclick="copyToClipboard('AUTORENTAL DATCOC 12345')"
                    >
