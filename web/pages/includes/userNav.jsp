  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><a href="MyTrips.jsp" class="nav-link text-dark">My trips</a></li>
      </ul>
      <div class="d-flex align-items-center ms-3 gap-3">
        ...
        <div class="d-flex align-items-center gap-2 ms-2">
          <div style="width:32px;height:32px;background:#d1d1d1;border-radius:50%;display:inline-block;"></div>
          <a href="UserAbout.jsp" class="text-dark" style="font-weight:500; text-decoration: none;">hywang1412</a>
