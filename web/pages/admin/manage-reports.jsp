        ...
        <main class="page-content">
          <div class="page-header">
            ...
            <p class="page-description">
              View comprehensive business insights and statistics
            </p>
          </div>
            ...
            datasets: [
              {
                label: "Revenue ($)",
                data: [
                  12000, 15000, 18000, 22000, 25000, 28000, 32000, 35000, 30000,
                  28000, 26000, 24000,
                ],
            ...
            datasets: [
              {
                label: "New Users",
                data: [
                  120, 145, 168, 192, 218, 245, 272, 298, 325, 352, 378, 405,
                ],
                borderColor: "#8b5cf6",
