...
<body>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-500">alice@autorental.com</div>
                                        ...
                                        <td>
                                            <div class="flex items-center gap-4">
                                                ...
                                                <button class="btn-ghost" onclick="disableStaff(1, 'Alice Johnson')">
                                                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/>
                                                    </svg>
                                                </button>
                                                <button class="btn-ghost" onclick="deleteStaff(1, 'Alice Johnson')">
                                                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-500">bob@autorental.com</div>
                                        ...
                                        <td>
                                            <div class="flex items-center gap-4">
                                                ...
                                                <button class="btn-ghost" onclick="disableStaff(2, 'Bob Smith')">
                                                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/>
                                                    </svg>
                                                </button>
                                                <button class="btn-ghost" onclick="deleteStaff(2, 'Bob Smith')">
                                                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                                        <path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12z"/>
                                                    </svg>
                                                </button>
    ...
    <div id="addStaffModal" class="modal-overlay" style="display: none;">
        <div class="modal">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveStaff()">Add Staff Member</button>
            </div>
        </div>
    </div>
    ...
    <div id="disableStaffModal" class="modal-overlay" style="display: none;">
        <div class="modal">
            <div class="modal-header">
                ...
                <p class="modal-description">Are you sure you want to disable this staff account?</p>
            </div>
            <div class="modal-content">
                <div class="form-group">
                    <label class="form-label">Reason for disabling</label>
                    <textarea class="form-textarea" id="disableReason" placeholder="Enter reason for disabling this account..."></textarea>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" onclick="closeDisableStaffModal()">Cancel</button>
                <button class="btn btn-danger" onclick="confirmDisableStaff()">Disable Account</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function confirmDisableStaff() {
            ...
            alert(`Staff account for ${currentStaffName} has been disabled. Reason: ${reason}`);
        ...
        function filterTable() {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                const departmentMatch = departmentFilter === 'all' || departmentText.includes(departmentFilter);
