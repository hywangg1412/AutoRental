      ...
      <body>
        <div class="admin-layout">
          ...
          <div class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
              ...
              <a href="${pageContext.request.contextPath}/pages/admin/manage-staff.jsp" class="nav-item active">
                <svg class="nav-item-icon" fill="currentColor" viewBox="0 0 24 24">
                  <path
                        ...
                        <c:forEach var="staff" items="${staffList}">
                          <tr>
                            <form method="post" action="StaffServlet">
                              ...
                              <td>
                                <input name="username" value="${staff.username}" size="8" required readonly
                                  style="width: 80px" />
                              </td>
                              <td>
                                <input name="email" value="${staff.email}" size="16" required readonly
                                  style="width: 140px" />
                              </td>
                              <td>
                                <input name="phoneNumber" value="${staff.phoneNumber}" size="10" style="width: 100px" />
                              </td>
                              <td>
                                <c:choose>
                              ...
                              <td>
                                <span class="badge ${staff.status eq 'Active' ? 'success' : 'danger'}">
                                  <c:out value="${staff.status}" default="Unknown" />
                                </span>
                              </td>
                              <td>
                                <button name="action" value="update" type="submit" class="btn btn-primary btn-sm">
                                  Save
                                </button>
                                <button name="action" value="delete" type="submit" class="btn btn-danger btn-sm"
        ...
        <div id="addStaffModal" class="modal-overlay" style="display: none">
          <div class="modal">
            <div class="modal-header">
              ...
              <p class="modal-description">Create a new staff account with appropriate permissions</p>
            </div>
            <div class="modal-content">
              <form id="addStaffForm" method="post" action="${pageContext.request.contextPath}/StaffServlet">
                ...
                <div class="modal-footer">
                  <button class="btn btn-secondary" type="button" onclick="closeAddStaffModal()">
                    Cancel
                  </button>
        ...
        <div id="editStaffModal" class="modal-overlay" style="display: none">
          <div class="modal">
            ...
            <div class="modal-content">
              <form id="editStaffForm" method="post" action="${pageContext.request.contextPath}/StaffServlet">
                ...
                <div class="modal-footer">
                  <button class="btn btn-secondary" type="button" onclick="closeEditStaffModal()">
                    Cancel
                  </button>
                  <button class="btn btn-primary" type="submit">
                    Save Changes
        ...
        <script>
          ...
          function openEditStaffModal(btn) {
            ...
            document.getElementById("editPhoneNumber").value = btn.getAttribute("data-phonenumber") || "";
            document.getElementById("editGender").value = btn.getAttribute("data-gender") || "";
            document.getElementById("editUserDOB").value = btn.getAttribute("data-userdob") || "";
