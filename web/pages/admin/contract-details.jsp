...
<body>
      ...
      <div class="sidebar" id="sidebar">
        <div class="sidebar-header" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center;">
          ...
          <nav class="sidebar-nav">
              ...
              <a href="${pageContext.request.contextPath}/pages/admin/contract-details.jsp" class="nav-item active">
                  <svg class="nav-item-icon" fill="currentColor" viewBox="0 0 24 24">
          ...
          <main class="page-content">
              ...
              <div class="filter-bar">
                  <div class="search-box">
                      ...
                      <input type="text" class="search-input" placeholder="Search contracts..." id="searchContracts">
                  </div>
                  ...
                  <div class="card-header">
                      <div class="flex items-center justify-between">
                          <div>
                              ...
                              <p class="card-description">View and manage rental contracts</p>
                          </div>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div>
                                              ...
                                              <div class="text-xs text-gray-500">+1 234 567 8900</div>
                                          </div>
                                      </td>
                                      <td>
                                          <div>
                                              <div class="font-medium">Toyota Corolla</div>
                                              <div class="text-sm text-gray-500">2023 • White • ABC-123</div>
                                      ...
                                      <td>
                                          <div>
                                              ...
                                              <div class="text-xs text-gray-500">Pickup: 10:00 AM</div>
                                          </div>
                                      </td>
                                      ...
                                      <td>
                                          <div class="flex items-center gap-4">
                                              ...
                                              <button class="btn-ghost" onclick="downloadContract(1)">
                                                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div>
                                              ...
                                              <div class="text-sm text-gray-500">2023 • Black • DEF-456</div>
                                      ...
                                      <td>
                                          <div>
                                              ...
                                              <div class="text-xs text-gray-500">Pickup: 2:00 PM</div>
                                          </div>
                                      </td>
                                      ...
                                      <td>
                                          <div class="flex items-center gap-4">
                                              ...
                                              <button class="btn-ghost" onclick="downloadContract(2)">
                                                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                                      <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>
                                                  </svg>
                                              </button>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div>
                                              ...
                                              <div class="text-sm text-gray-500">2024 • Silver • GHI-789</div>
                                      ...
                                      <td>
                                          <div>
                                              ...
                                              <div class="text-sm text-gray-500">7 days</div>
                                              <div class="text-xs text-gray-500">Pickup: 9:00 AM</div>
                                          </div>
                                      </td>
                                      ...
                                      <td>
                                          <div class="flex items-center gap-4">
                                              ...
                                              <button class="btn-ghost" onclick="downloadContract(3)">
                                                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                                      <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>
                                                  </svg>
                                              </button>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div>
                                              ...
                                              <div class="text-sm text-gray-500">2023 • Blue • JKL-012</div>
                                      ...
                                      <td>
                                          <div>
                                              ...
                                              <div class="text-xs text-gray-500">Pickup: 11:00 AM</div>
                                          </div>
                                      </td>
                                      ...
                                      <td>
                                          <div class="flex items-center gap-4">
                                              ...
                                              <button class="btn-ghost" onclick="downloadContract(4)">
                                                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                                                      <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>
                                                  </svg>
                                              </button>
  ...
  <div id="contractModal" class="modal-overlay" style="display: none;">
      <div class="modal" style="max-width: 800px;">
                  ...
                  <div class="card-content">
                      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                          ...
                          <div>
                              ...
                              <p class="font-bold" style="font-size: 18px; color: #2563eb;" id="totalAmount">$163.50</p>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="modal-footer">
              ...
              <button class="btn btn-primary" onclick="downloadContract()">Download PDF</button>
          </div>
      </div>
  </div>
  ...
  <script>
      ...
      document.getElementById('searchContracts').addEventListener('input', function(e) {
