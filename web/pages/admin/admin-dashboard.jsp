...
<html lang="en">
  ...
  <body>
    <!-- Access Control: Redirect if not Admin or Staff -->
    <c:if
      test="${sessionScope.user == null || (sessionScope.userRole != 'Admin' && sessionScope.userRole != 'Staff')}"
    >
      <c:redirect url="/pages/authen/access-denied.jsp" />
    </c:if>
    ...
    <div class="admin-layout">
      ...
      <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <a
            href="${pageContext.request.contextPath}/pages/admin/manage-staff.jsp"
            class="nav-item"
          >
            <svg class="nav-item-icon" fill="currentColor" viewBox="0 0 24 24">
              <path
        ...
        <div class="sidebar-user">
          <div class="user-info">
            <div class="user-avatar">
              <c:out
                value="${sessionScope.user.firstName.charAt(0)}${sessionScope.user.lastName.charAt(0)}"
              />
            </div>
            <div class="user-details">
              ...
              <p>
                <c:out
                  value="${sessionScope.userRole == 'Admin' ? 'Administrator' : 'Staff'}"
                />
              </p>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="flex items-center justify-between">
                ...
                <a
                  href="${pageContext.request.contextPath}/pages/admin/manage-bookings.jsp"
                    ...
                    <c:forEach var="booking" items="${recentBookings}">
                      <tr>
                        ...
                        <td>
                          <div>
                            <div class="font-medium">
                              <c:out value="${booking.carModel}" />
                            </div>
                            <div class="text-sm">
                              <c:out value="${booking.categoryName}" />
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <span
                            class="badge ${booking.status == 'Confirmed' ? 'success' : booking.status == 'Pending' ? 'warning' : 'info'}"
                            >${booking.status}</span
                          >
                        </td>
                        <td>
                          <div class="flex items-center gap-4">
                            <a
                              href="${pageContext.request.contextPath}/pages/admin/booking-details.jsp?bookingId=${booking.bookingId}"
                              class="btn-ghost"
                            >
                              <svg
                                width="16"
                            ...
                            <a
                              href="${pageContext.request.contextPath}/pages/admin/edit-booking.jsp?bookingId=${booking.bookingId}"
                              class="btn-ghost"
                            >
                              <svg
                                width="16"
