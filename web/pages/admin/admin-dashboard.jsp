  ...
  <div class="admin-layout">
      ...
      <div class="sidebar" id="sidebar">
          ...
          <nav class="sidebar-nav">
              <a href="${pageContext.request.contextPath}/pages/admin/admin-dashboard.jsp" class="nav-item active">
              ...
              <a href="${pageContext.request.contextPath}/StaffServlet" class="nav-item">
                  <svg class="nav-item-icon" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="main-content">
          ...
          <main class="page-content">
              <div class="page-header">
                  ...
                  <p class="page-description">Welcome to AutoRental Admin Dashboard</p>
              </div>
              ...
              <div class="card">
                  <div class="card-header">
                      <div class="flex items-center justify-between">
                          ...
                          <a href="${pageContext.request.contextPath}/BookingApprovalListServlet" class="btn btn-primary">View All</a>
                      </div>
                  </div>
