  ...
  <body>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="flex items-center gap-4">
                          ...
                          <button
                            class="btn-ghost"
                            onclick="deleteUser(2, 'Jane Smith')"
                          >
                            <svg
                              width="16"
                              height="16"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="flex items-center gap-4">
                          ...
                          <button
                            class="btn-ghost"
                            onclick="unbanUser(3, 'Mike Johnson')"
                          >
                            <svg
                              width="16"
                              height="16"
                          ...
                          <button
                            class="btn-ghost"
                            onclick="deleteUser(3, 'Mike Johnson')"
                          >
                            <svg
                              width="16"
                              height="16"
    ...
    <div id="banUserModal" class="modal-overlay" style="display: none">
      <div class="modal">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary" onclick="closeBanUserModal()">
            Cancel
          </button>
