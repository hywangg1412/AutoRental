                    ...
                    <body class="car-page">
                        ...
                        <section class="ftco-section bg-light">
                            <div class="container" style="max-width: 1140px; margin-top: 80px;">
                                ...
                                <div class="d-flex align-items-center mb-4" style="max-width: 100%;">
                                    ...
                                    <form method="get" action="car" class="flex-grow-1 d-flex align-items-center gap-3"
                                        ...
                                        <select name="sort" id="sortSelect" class="sort-select form-select"
                                            style="max-width: 160px; border-radius: 16px; border: 1.5px solid #ddd;"
                                            ...
                                            <c:forEach var="car" items="${carList}">
                                                <div class="col-lg-4 col-md-6 col-12 d-flex">
                                                    <div class="car-wrap rounded ftco-animate h-100 w-100">
                                                        ...
                                                        <div class="text p-3">
                                                            <div
                                                                class="car-title-row d-flex align-items-center justify-content-between mb-2">
                                                                ...
                                                                <span
                                                                    class="car-status-inline ${car.statusCssClass} badge ms-2">${car.statusDisplay}</span>
                                                            </div>
                                                            <div
                                                                class="d-flex justify-content-between align-items-center mb-3">
                                                                <span
                                                                    class="cat text-muted small">${car.brandName}</span>
                                                                ...
                                                                <div class="row g-1">
                                                                    <div class="col-12">
                                                                        <a href="${pageContext.request.contextPath}/booking/form/details?id=${car.carId}"
                                                                            class="btn btn-primary btn-sm w-100">Book
                                                                            now</a>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-1">
                                                                    <div class="col-6">
                                                                        <a href="${pageContext.request.contextPath}/pages/car-single?id=${car.carId}"
                                                                            class="btn btn-outline-secondary btn-sm w-100">Details</a>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <a href="${pageContext.request.contextPath}/pages/add-to-cart?id=${car.carId}"
                                                                            class="btn btn-outline-primary btn-sm w-100">Add
                                                                            Cart</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <li class="page-item"><a class="page-link"
                                                                        href="?page=${i}&keyword=${param.keyword}<c:forEach var='brand' items='${paramValues.brandId}'>&brandId=${brand}</c:forEach><c:forEach var='fuel' items='${paramValues.fuelTypeId}'>&fuelTypeId=${fuel}</c:forEach><c:forEach var='cat' items='${paramValues.categoryId}'>&categoryId=${cat}</c:forEach><c:forEach var='st' items='${paramValues.status}'>&status=${st}</c:forEach><c:forEach var='feature' items='${paramValues.featureId}'>&featureId=${feature}</c:forEach><c:if test='${not empty param.sort}'>&sort=${param.sort}</c:if>">${i}</a>
                                                                </li>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </c:forEach>
