                ...
                <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                    <% CarDetailDTO car=(CarDetailDTO) request.getAttribute("car"); %>
                        ...
                        <head>
                            ...
                            <link rel="stylesheet"
                                href="${pageContext.request.contextPath}/css/car-single.css?v=<%=System.currentTimeMillis()%>">
                                    ...
                                    <div
                                        ...
                                        <div class="col-md-9 ftco-animate pb-5">
                                            <p class="breadcrumbs"><span class="mr-2"><a
                                                        href="${pageContext.request.contextPath}/pages/index.jsp">Home
                                                        <i class="ion-ios-arrow-forward"></i></a></span> <span>Cars <i
                                                        class="ion-ios-arrow-forward"></i></span> <span>Car Details <i
                                        ...
                                        <div class="col-md-12">
                                            <div class="car-details">
                                                <div class="img rounded"
                                                    style="background-image: url('${pageContext.request.contextPath}<%= car.getImageUrls().get(0)%>');">
                                                </div>
                                            ...
                                            <div class="media block-6 services">
                                                <div class="media-body py-md-4">
                                                    <div class="d-flex mb-3 align-items-center">
                                                        ...
                                                        <div class="text">
                                                            <h3 class="heading mb-0 pl-3">Mileage<span>
                                                                    <%= car.getOdometer()%> km
                                                                </span></h3>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="media block-6 services">
                                                <div class="media-body py-md-4">
                                                    <div class="d-flex mb-3 align-items-center">
                                                        ...
                                                        <div class="text">
                                                            <h3 class="heading mb-0 pl-3">Transmission<span>
                                                                    <%= car.getTransmissionName()%>
                                                                </span></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="media block-6 services">
                                                <div class="media-body py-md-4">
                                                    <div class="d-flex mb-3 align-items-center">
                                                        ...
                                                        <div class="text">
                                                            <h3 class="heading mb-0 pl-3">Seats<span>
                                                                    <%= car.getSeats()%> Adults
                                                                </span></h3>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="media block-6 services">
                                                <div class="media-body py-md-4">
                                                    <div class="d-flex mb-3 align-items-center">
                                                        ...
                                                        <div class="text">
                                                            <h3 class="heading mb-0 pl-3">Fuel<span>
                                                                    <%= car.getFuelName()%>
                                                                </span></h3>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="car-price-info">
                                                ...
                                                <p class="price ml-auto">
                                                    <fmt:formatNumber value="${car.pricePerDay * 1000}" type="number"
                                                        pattern="#,###,###" /> <span>&nbsp;VND/day</span>
                                                </p>
                                                <div class="price-label">Price per hour</div>
                                                <p class="price ml-auto">
                                                    <fmt:formatNumber value="${car.pricePerHour * 1000}" type="number"
                                                        pattern="#,###" /> <span>&nbsp;VND/hour</span>
                                                </p>
                                            </div>
                                            <div class="car-action-buttons">
                                                <a href="${pageContext.request.contextPath}/booking/form/details?id=<%= car.getCarId()%>"
                                                    ...
                                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" id="pills-description-tab"
                                                                data-bs-toggle="pill" href="#pills-description"
                                                                role="tab" aria-controls="pills-description"
                                                                aria-selected="true">Features</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="pills-manufacturer-tab"
                                                                data-bs-toggle="pill" href="#pills-manufacturer"
                                                                role="tab" aria-controls="pills-manufacturer"
                                                                aria-selected="false">Description</a>
                                                        </li>
                                                        <!-- Tab Review -->
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="pills-review-tab"
                                                                data-bs-toggle="pill" href="#pills-review" role="tab"
                                                    ...
                                                    <div class="tab-pane fade show active" id="pills-description"
                                                        ...
                                                        <div class="row">
                                                            <c:forEach var="col" begin="0" end="2">
                                                                <div class="col-md-4">
                                                                    <ul class="features">
                                                                        <c:forEach var="i" begin="${col*5}"
                                                                            end="${col*5+4}">
                                                                            <c:if
                                                                                test="${i < car.allFeatureNames.size()}">
                                                                                <li
                                                                                    class="${car.featureNames.contains(car.allFeatureNames[i]) ? 'check' : 'uncheck'}">
                                                                                    <span
                                                                                        class="${car.featureNames.contains(car.allFeatureNames[i]) ? 'ion-ios-checkmark-circle' : 'ion-ios-close-circle'}"></span>
                                                    ...
                                                    <div class="tab-pane fade" id="pills-manufacturer" role="tabpanel"
                                                        ...
                                                        <p>
                                                            <%= car.getDescription() !=null &&
                                                                !car.getDescription().isEmpty() ? car.getDescription()
                                                    ...
                                                    <div class="tab-pane fade" id="pills-review" role="tabpanel"
                                                        ...
                                                        <div class="review-section-row">
                                                            <div class="review-list-col">
                                                                ...
                                                                <c:choose>
                                                                    <c:when
                                                                        test="${empty reviews && userReview == null}">
                                                                    ...
                                                                    <c:otherwise>
                                                                        ...
                                                                        <c:if test="${userReview != null}">
                                                                            <div class="review d-flex mb-4 border p-3 rounded"
                                                                                style="background-color: #f8f9fa;"
                                                                                data-feedback-id="${userReview.feedbackId}">
                                                                                <div class="user-img me-3"
                                                                                    style="background-image: url('${not empty userReview.userAvatar ? fn:escapeXml(userReview.userAvatar) : pageContext.request.contextPath}/assets/images/person_1.jpg'); width: 60px; height: 60px; border-radius: 50%; background-size: cover;">
                                                                                </div>
                                                                                <div class="desc flex-grow-1">
                                                                                    <div
                                                                                        class="d-flex justify-content-between mb-2">
                                                                                        <h5 class="mb-0">${not empty
                                                                                            userReview.username ?
                                                                                            fn:escapeXml(userReview.username)
                                                                                            : userName}</h5>
                                                                                        <div
                                                                                            class="d-flex align-items-center">
                                                                                            <small
                                                                                                class="text-muted me-3">${userReview.formattedCreatedDate}</small>
                                                                                            <button
                                                                                                class="btn btn-sm btn-outline-primary edit-feedback"
                                                                                                data-bs-toggle="modal"
                                                                                                data-bs-target="#editFeedbackModal"
                                                                                                data-feedback-id="${userReview.feedbackId}"
                                                                                                data-rating="${userReview.rating}"
                                                                                                data-content="${fn:escapeXml(userReview.content)}">
                                                                                                <i
                                                                                                    class="fas fa-edit"></i>
                                                                                                Edit
                                                                                            </button>
                                                                                    ...
                                                                                    <div class="review-content p-3 rounded"
                                                                                        style="background-color: #e9ecef;">
                                                                                        <p class="mb-1">
                                                                                            <strong>Rating:</strong>
                                                                                            ${userReview.rating}/5
                                                                                            ${userReview.ratingStarsHtml}
                                                                                        </p>
                                                                                        <p class="mb-1">
                                                                                            <strong>Content:</strong>
                                                                                            ${fn:escapeXml(userReview.content)}
                                                                                        </p>
                                                                                        <p class="mb-0">
                                                                                            <strong>Date:</strong>
                                                                                            ${userReview.formattedCreatedDate}
                                                                                        </p>
                                                                                        <c:if
                                                                                            test="${sessionScope.userId == userReview.userId.toString()}">
                                                                                            <p class="mb-0"><small
                                                                                                    class="text-muted">Booking
                                                                                                    Code: ${not empty
                                                                                                    userReview.bookingCode
                                                                                                    ?
                                                                                                    userReview.bookingCode
                                                                                                    : 'N/A'}</small></p>
                                                                                        </c:if>
                                                                                    ...
                                                                                    <c:if
                                                                                        test="${not empty userReview.staffReply}">
                                                                                        <div class="staff-reply mt-2">
                                                                                            <div
                                                                                                class="staff-reply-header">
                                                                                                <i
                                                                                                    class="fas fa-reply"></i>
                                                                                                <span>Staff
                                                                                                    Response</span>
                                                                                                <span
                                                                                                    class="staff-reply-date">
                                                                                                    ${userReview.formattedReplyDate}
                                                                                                </span>
                                                                                            </div>
                                                                                            <div
                                                                                                class="staff-reply-content">
                                                                            ...
                                                                            <c:if test="${not empty userOtherReviews}">
                                                                                ...
                                                                                <c:forEach var="review"
                                                                                    items="${userOtherReviews}">
                                                                                    <div class="review d-flex mb-4 border p-3 rounded"
                                                                                        style="background-color: #f8f9fa;"
                                                                                        data-feedback-id="${review.feedbackId}">
                                                                                        <div class="user-img me-3"
                                                                                            style="background-image: url('${not empty review.userAvatar ? fn:escapeXml(review.userAvatar) : pageContext.request.contextPath}/assets/images/person_1.jpg'); width: 60px; height: 60px; border-radius: 50%; background-size: cover;">
                                                                                        </div>
                                                                                        <div class="desc flex-grow-1">
                                                                                            <div
                                                                                                class="d-flex justify-content-between mb-2">
                                                                                                <h5 class="mb-0">${not
                                                                                                    empty
                                                                                                    review.username ?
                                                                                                    fn:escapeXml(review.username)
                                                                                                    : userName}</h5>
                                                                                                <div
                                                                                                    class="d-flex align-items-center">
                                                                                                    <small
                                                                                                        class="text-muted me-3">${review.formattedCreatedDate}</small>
                                                                                                    <button
                                                                                                        class="btn btn-sm btn-outline-primary edit-feedback"
                                                                                                        data-bs-toggle="modal"
                                                                                                        data-bs-target="#editFeedbackModal"
                                                                                            ...
                                                                                            <div class="review-content p-3 rounded"
                                                                                                ...
                                                                                                <c:if
                                                                                                    test="${sessionScope.userId == review.userId.toString()}">
                                                                                                    <p class="mb-0">
                                                                                                        <small
                                                                                                            class="text-muted">Booking
                                                                                                            Code: ${not
                                                                                            ...
                                                                                            <!-- Hiển thị phản hồi của nhân viên nếu có -->
                                                                                            <c:if
                                                                                                test="${not empty review.staffReply}">
                                                                                                <div
                                                                                                    class="staff-reply mt-2">
                                                                                                    <div
                                                                                                        class="staff-reply-header">
                                                                                                        <i
                                                                                                            class="fas fa-reply"></i>
                                                                                ...
                                                                                <div class="desc flex-grow-1">
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <c:if
                                                                                                test="${sessionScope.userId == review.userId}">
                                                                                                <button
                                                                                                    class="btn btn-sm btn-outline-primary edit-feedback"
                                                                                                    data-bs-toggle="modal"
                                                                                                    data-bs-target="#editFeedbackModal"
                                                            ...
                                                            <div class="review-summary-col">
                                                                <div class="rating-wrap">
                                                                    <h3 class="head">Average Rating: ${averageRating !=
                                                                        null ? fn:escapeXml(String.format('%.2f',
                                                                        averageRating)) : 'None'} / 5</h3>
                                                                        ...
                                                                        <form id="reviewForm"
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <textarea class="form-control"
                                                                                    name="content" id="content" rows="4"
                                                                                    required></textarea>
                                                                            </div>
                                                                            <button type="submit"
                                                                    ...
                                                                    <c:if test="${canReview && userReview != null}">
                                                                        <div class="mt-4">
                                                                            <button id="showNewReviewFormBtn"
                                                                            ...
                                                                            <div id="newReviewFormContainer"
                                                                                ...
                                                                                <form id="newReviewForm"
                                                                                    ...
                                                                                    <button type="button"
                                                                                        ...
                                                                                        id="cancelNewReviewBtn">Cancel</button>
                                                                                </form>
                                                                            </div>
                                                                        </div>
                                                                    </c:if>
                                                                    ...
                                                                    <c:if test="${not canReview || userReview != null}">
                                                                        <p class="alert alert-info">
                                                                            <c:choose>
                                                                                <c:when
                                                                                    test="${userReview != null and not canReview}">
                                                                                    You have already submitted a review
                                                                                    for this car.
                                                                                </c:when>
                                                                                <c:when
                                                                                    test="${userReview != null and canReview}">
                                                                                    You have already submitted a review
                                                                                    for this car, but you can add
                                                                                    another review for your latest
                                                                                    completed booking.
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                    You need to login and have a
                                                                                    completed booking to submit a
                                                                                    review.
                                                                                </c:otherwise>
                                                                            </c:choose>
                                                                        </p>
                                                        ...
                                                        <div class="modal fade" id="editFeedbackModal" tabindex="-1"
                                                            aria-labelledby="editFeedbackModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="editFeedbackModalLabel">Edit Review</h5>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div id="editFeedbackMessage"
                            ...
                            <div class="modal fade" id="updateSuccessModal" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="d-flex align-items-center">
                                                <i class="bi bi-pencil-fill text-primary me-3"
                                                    style="font-size: 2rem;"></i>
                                                <div>
