        ...
        <div class="container">
            <div class="row g-5" style="margin-top: 80px;">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="sidebar">
                        <h2 class="h2 fw-bold mb-3">Hello Staff!</h2>
                        <ul class="sidebar-menu">
                            <li><a href="${pageContext.request.contextPath}/user/profile" class="nav-link active text-dark border-top-custom">
                                    <i class="bi bi-person text-dark"></i>
                                    My account
                                </a></li>
                            <li><a href="${pageContext.request.contextPath}/pages/staff/profile/staff-change-password.jsp" class="nav-link text-dark border-bottom-custom">
