...
<head>
    ...
    <link rel="stylesheet" href="styles/user/longtermrender.css">
</head>
<body>
    <!-- Header -->
    <header class="header">
    ...
    <li><a href="longtermrender.jsp" class="nav-link active">
    ...
    <li><a href="changeaddress.jsp" class="nav-link">
        <i class="bi bi-lock"></i>
        Change password
    </a></li>
    <li><a href="requestdelete" class="nav-link">
