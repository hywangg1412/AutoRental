    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body>
                            ...
                            <div class="col-lg-8 ftco-animate">
                                <div class="text w-100 text-center mb-md-5 pb-md-5">
                                    ...
                                    <p style="font-size: 18px;">
                                        Discover the best car rental experience with AutoRental. We offer a wide range
                                        of vehicles, affordable prices, and excellent customer service to make your
                                    ...
                                    <c:forEach var="car" items="${carList}" varStatus="status">
                                        <c:if test="${status.index < 6}">
                                            <div class="col-md-4 mb-4">
                                                <a href="${pageContext.request.contextPath}/pages/car-single?id=${car.carId}" class="text-decoration-none" style="display:block; color:inherit;">
                                                    <div class="car-wrap rounded ftco-animate" style="border: 1.5px solid #e0e0e0; border-radius: 18px !important; overflow: hidden;">
                                                        <div class="img rounded d-flex align-items-end"
                                                             style="background-image: url('${pageContext.request.contextPath}${car.mainImageUrl}'); border-radius: 18px 18px 0 0;">
                                                        </div>
                                                        <div class="card-body pb-2">
                                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                                <span class="card-title mb-0" style="font-size: 1.1rem; font-weight: 600;">
                                                                    ${car.carModel}
                                                                </span>
                                                                <span class="badge ${car.statusCssClass}" style="min-width: 70px; text-align: center;">${car.statusDisplay}</span>
                                                            </div>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center mt-2"
                                                                ...
                                                                <span class="d-flex align-items-center"
                                                                    style="min-width: 90px;"><i
                                                                        ...
                                                                        style="font-size: 1.1em;"></i>${car.transmissionTypeName}</span>
                                                                <span class="d-flex align-items-center"
                                                                    style="min-width: 70px;"><i class="bi bi-person-fill me-1"
                                                                        style="font-size: 1.1em;"></i>${car.seats} seats</span>
                                                                <span class="d-flex align-items-center"
                                                                    style="min-width: 90px;"><i class="bi bi-fuel-pump me-1"
                                                                        style="font-size: 1.1em;"></i>${car.fuelName}</span>
                                                            </div>
                                                            ...
                                                            <div class="d-flex align-items-center mt-3"
                                                                ...
                                                                <span class="fw-bold" style="color: #444;">
                                                                    <c:choose>
                                                                        <c:when test="${car.averageRating != null}">
                                                                            <fmt:formatNumber value="${car.averageRating}"
                                                                ...
                                                                <span class="fw-bold"
                                                                    ...
                                                                    <fmt:formatNumber value="${car.pricePerHour * 1000}"
                                                                        type="number" pattern="#,#00" />
                                                                </span>
                                                                <span class="ms-1"
                                                                    style="color: #888; font-size: 1rem;">VND/hour</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                ...
                <section class="container py-5">
                    ...
                    <div class="row mb-4 align-items-start">
                        <div class="col-lg-3 mb-3 mb-lg-0 d-flex align-items-start">
                            <h1 class="fw-bold mb-3 text-break"
                                style="font-size: 2.2rem; line-height: 1.2; font-family: 'Poppins', Arial, sans-serif;">
                                AutoRental – With you on every journey
                            </h1>
                        </div>
                        <div class="col-lg-9 d-flex align-items-start">
                            <div
                                style="color: #222; font-size: 1.2rem; font-family: 'Poppins', Arial, sans-serif; text-align: justify; max-width: 95%;">
                                Every trip is a journey to explore life and the world around us—a chance to learn and
                                conquer new things, making each individual better. Therefore, customer experience
                                quality is always our top priority and the source of inspiration for the AutoRental
                                team.<br><br>
                                AutoRental is a car-sharing platform. Our mission goes beyond simply connecting car
                                owners and customers quickly, safely, and conveniently. We aim to inspire the community
                                to DISCOVER new things through every journey on our platform.
                            </div>
                        </div>
                    </div>
                    <!-- Bottom row: 1 image -->
                    <div class="row g-3">
                        <div class="col-12">
                            <img src="${pageContext.request.contextPath}/assets/images/about/aboutus1.4c31a699.png"
                                class="img-fluid rounded-4 w-100" alt="About 1"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <h1 class="fw-bold mb-3"
                                style="font-size: 3rem; font-family: 'Poppins', Arial, sans-serif; color: #222;">
                            ...
                            <p style="color: #222; font-size: 1.2rem;">
                                AutoRental aims to become the #1 reputable and civilized car-sharing community in
                                Vietnam, bringing practical value to all members for a better life.
                            </p>
                            <p style="color: #222; font-size: 1.2rem;">
                                We believe that every journey matters. That’s why the AutoRental team and our partners,
                                with extensive experience in car rental, technology, insurance, and tourism, will bring
                                you new, exciting, and safe experiences on every trip.
                            </p>
                        </div>
                        <!-- Bên phải: Ảnh -->
                        <div class="col-lg-6">
                ...
                <section class="container py-5 mt-5">
                    <div class="text-center mb-4">
                        ...
                        <p class="mb-0" style="color: #444; font-size: 1.2rem;">Just 4 simple steps to experience car
                            rental with AutoRental quickly and easily</p>
                    </div>
                    <div class="row justify-content-center g-4">
                        <div class="col-12 col-sm-6 col-lg-3 d-flex flex-column align-items-center">
                            <div class="mb-3 d-flex align-items-center justify-content-center"
                                style="width: 96px; height: 96px; background: #eafaf0; border-radius: 20px;">
                            ...
                            <div class="d-flex align-items-baseline" style="width: 100%; justify-content: flex-start;">
                                <span
                                    style="color: #5FCF86; font-weight: bold; font-size: 1.5rem; min-width: 2.5rem;">01</span>
                                <span class="fw-bold"
                                    style="font-size: 1.25rem; color: #111; margin-left: 0.5rem; text-align: left; line-height: 1.2;">Book
                                    a car on<br>AutoRental app/web</span>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-3 d-flex flex-column align-items-center">
                            <div class="mb-3 d-flex align-items-center justify-content-center"
                            ...
                            <div class="d-flex align-items-baseline" style="width: 100%; justify-content: flex-start;">
                                <span
                                    style="color: #5FCF86; font-weight: bold; font-size: 1.5rem; min-width: 2.5rem;">02</span>
                                <span class="fw-bold"
                                    style="font-size: 1.25rem; color: #111; margin-left: 0.5rem; text-align: left; line-height: 1.2;">Receive
                                    the car</span>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-3 d-flex flex-column align-items-center">
                            ...
                            <div class="d-flex align-items-baseline" style="width: 100%; justify-content: flex-start;">
                                <span
                                    style="color: #5FCF86; font-weight: bold; font-size: 1.5rem; min-width: 2.5rem;">03</span>
                                <span class="fw-bold"
                                    style="font-size: 1.25rem; color: #111; margin-left: 0.5rem; text-align: left; line-height: 1.2;">Start
                                    your journey</span>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-3 d-flex flex-column align-items-center">
                            ...
                            <div class="d-flex align-items-baseline" style="width: 100%; justify-content: flex-start;">
                                <span
                                    style="color: #5FCF86; font-weight: bold; font-size: 1.5rem; min-width: 2.5rem;">04</span>
                                <span class="fw-bold"
                                    style="font-size: 1.25rem; color: #111; margin-left: 0.5rem; text-align: left; line-height: 1.2;">Return
                                    the car & finish<br>your trip</span>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <div class="container">
                ...
                <section class="container py-5 mt-5"> <!-- Thêm mt-5 để tăng khoảng cách phía trên -->
                    <div class="row align-items-center justify-content-center">
                        <div class="col-12 col-lg-6 d-flex justify-content-center align-items-center mb-4 mb-lg-0">
                            <img src="${pageContext.request.contextPath}/assets/images/about/thue_xe.png"
                                alt="Self-drive car" class="img-fluid rounded-4"
                                style="max-width: 100%; height: 320px; object-fit: cover;">
                        </div>
                        <div class="col-12 col-lg-6 d-flex flex-column justify-content-center align-items-start">
                            <h2 class="fw-bold mb-3" style="font-size: 2.7rem; color: #222; line-height: 1.15;">The car
                                is ready.<br>Start your journey now!</h2>
                            <p class="mb-4"
                                style="color: #444; font-size: 1.25rem; max-width: 600px; line-height: 1.5;">
                                Take the wheel of your favorite car and make your trip more exciting.
                            </p>
                            <a href="${pageContext.request.contextPath}/pages/car" class="btn btn-selfdrive">Rent a
                                car</a>
                        </div>
                    </div>
                </section>
