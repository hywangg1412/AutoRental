...
/**
 * Servlet xử lý việc staff duyệt booking (approve/reject) URL:
 * /staff/approve-booking Method: POST
 *
 * Parameters: - bookingId: ID của booking cần duyệt (bắt buộc) - action:
 * "approve" hoặc "reject" (bắt buộc) - note: Ghi chú khi duyệt (tùy chọn) -
