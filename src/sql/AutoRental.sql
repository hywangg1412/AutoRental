...
CREATE TABLE [CitizenIdCards] (
    ...
    [DOB]                      DATE NOT NULL,
    [CitizenIdImageUrl]        NVARCHAR(500) NOT NULL,
    [CitizenIdBackImageUrl]    NVARCHAR(500) NOT NULL,
...
CREATE TABLE [Contract] (
    ...
    [SignatureMethod]       VARCHAR(20) NULL,
    [ContractPdfUrl]        NVARCHAR(500) NULL,
    [ContractFileType]      VARCHAR(20) NULL,
...
CREATE TABLE [UserFeedback] (
    ...
    CONSTRAINT [FK_UserFeedback_UserId]
      ...
      ON DELETE CASCADE,
    CONSTRAINT [FK_UserFeedback_CarId]
      FOREIGN KEY ([CarId])
      REFERENCES [Car]([CarId])
      ON DELETE SET NULL,
    CONSTRAINT [FK_UserFeedback_BookingId]
